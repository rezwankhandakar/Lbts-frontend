 ...
 *
 * Deliberately not a `<datalist>`: browsers style and filter those themselves,
 * inconsistently, and Safari barely supports them. This is a plain input with
 * a list under it — so it looks like every other field in the form, and the
 * keyboard works the way an operator expects.
 *
 * Typing is never blocked. A suggestion is an offer, not a constraint: a
 * customer who has never appeared before has to be typeable, so the list can
